...
public abstract class AsyncEscPosPrint extends AsyncTask<AsyncEscPosPrinter, Integer, Integer> {
    ...
    protected final static int FINISH_MISSING_PERMISSIONS = 7;
...
/*                new AlertDialog.Builder(context)
            ...
            case AsyncEscPosPrint.FINISH_BARCODE_ERROR:
                new AlertDialog.Builder(context)
                    ...
                    .show();
                break;
            case AsyncEscPosPrint.FINISH_MISSING_PERMISSIONS:
                new AlertDialog.Builder(context)
                    .setTitle("Missing Permissions")
                    .setMessage("Application does not have sufficient permissions to print to Bluetooth.")
                    .show();
        }
    }
}
