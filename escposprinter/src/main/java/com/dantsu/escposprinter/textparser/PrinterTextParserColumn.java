...
/*                                case PrinterTextParser.TAGS_BARCODE:
        ...
        Log.i("PrinterParseCol", "ImgOrBar");
 /*       if (!isImgOrBarcodeLine) {
            // =================================================================
            // If the tag is for format text
            Log.i("PrinterParseCol", "ImgOrBar1");
...
/*    private PrinterTextParserColumn appendQRCode(String textAlign, Hashtable<String, String> qrCodeAttributes, String data) throws EscPosParserException  {
